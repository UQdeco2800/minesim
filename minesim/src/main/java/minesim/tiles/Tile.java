...
public enum Tile {
    ...
    GOLD((byte) 4, "Gold", "texturepack/missing.png", true),
    SILVER((byte) 5, "Silver", "texturepack/missing.png", true),
    COPPER((byte) 6, "Copper", "texturepack/missing.png", true),
    IRON((byte) 7, "Iron", "texturepack/missing.png", true),
    RUBY((byte) 8, "Ruby", "texturepack/missing.png", true),
    SAPPHIRE((byte) 9, "Sapphire", "texturepack/missing.png", true),
    DIAMOND((byte) 10, "Diamond", "texturepack/missing.png", true),
    EMERALD((byte) 11, "Emerald", "texturepack/missing.png", true),
